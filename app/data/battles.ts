...
export const BATTLES: Battle[] = [
  ...
  {
    id: 'kharkov-1',
    wikipediaSlug: 'Schlacht_bei_Charkow_(1941)',
    name: 'Erste Schlacht um Charkow',
    start: '1941-10-20',
    end: '1941-10-24',
    coordinates: [36.2304, 49.9935],
    major: false,
    summary:
      'Nach der Kesselschlacht von Kiew stieß die deutsche 6. Armee (Reichenau) ab Anfang Oktober 1941 durch Sumy/Ochtyrka auf das ostukrainische Industriezentrum vor. Die sowjetische 38. Armee (Zyganow) führte ein bewusstes Verzögerungsgefecht, bis die 70 wichtigsten Betriebe per 320 Eisenbahnzüge evakuiert waren — am 24. Oktober nahm das LV. AK die Stadt nach nur kurzen Häuserkämpfen ein.',
    forces: [
      {
        side: 'axis',
        commander: 'Walter von Reichenau (AOK 6)',
        troops: '~80.000 (LV. AK Hauptkraft)',
        units: [
          'Heeresgruppe Süd (Rundstedt)',
          '6. Armee (Reichenau)',
          'LV. Armeekorps (Vierow)',
          '57. Infanterie-Division (Dostler)',
          '101. leichte Division (Brauner von Haydringen)',
          '100. leichte Division (Sanne)',
          '239. Infanterie-Division',
          'XVII. Armeekorps (Kienitz)',
          'Sturmgeschütz-Abteilung 197 (Barisani)',
        ],
        tanks: 'keine Panzerverbände — Schwerpunkt Infanterie + StuG-Unterstützung',
        casualties: 'niedrig (4-stellig, ~1.000–1.500 Gefallene/Verwundete)',
      },
      {
        side: 'soviet',
        commander: 'Wiktor W. Zyganow (38. Armee) · Semjon Timoschenko (Südwestfront)',
        troops: '~20.000 in der Stadt + Verzögerungstruppen im Vorfeld',
        units: [
          'Südwestfront (Timoschenko)',
          '38. Armee (Zyganow)',
          '216. Schützen-Division (Makshanow)',
          '57. NKWD-Brigade (Sokolow)',
          'Volkswehr-Bataillone Charkow',
        ],
        casualties: '~10.000–15.000 Gefangene + Gefallene; 216. SchD weitgehend zerschlagen',
      },
    ],
    outcome:
      'Deutsche Eroberung Charkows am 24. Oktober 1941 nach planmäßiger sowjetischer Rückzugsaktion. 70 Großbetriebe (KhPZ/T-34-Produktion, KhTZ-Traktorenwerk, Flugzeugwerk Nr. 135) waren mit 320 Zügen nach Nischni Tagil, Tscheljabinsk und Perm evakuiert; verbleibende Anlagen wurden gesprengt. Die 38. Armee setzte sich planmäßig hinter den Sewerski Donez ab, wo das XVII. AK am 29. Oktober bei Stary Saltow einen Brückenkopf bildete. Beginn der deutschen Besatzung Charkows bis 16. Februar 1943.',
    notableUnits: [
      '57. Infanterie-Division',
      '101. leichte Division',
      'LV. Armeekorps',
      '216. Schützen-Division',
      '57. NKWD-Brigade',
    ],
  },
  {
