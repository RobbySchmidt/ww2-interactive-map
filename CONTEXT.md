...
26. ✅ **Visuelle Prüfung + Frontlinien-Fixes (2026-09-05)**: Headless-Sweep (Playwright-Core + Edge/SwiftShader) über alle 18 Snapshots, 17 Zwischenpunkte und 15 Stadt-Zooms. Ergebnis und Fixes:
    ...
    - **OSM-Attribution verlinkt** (ODbL): „© OpenStreetMap-Mitwirkende" zeigt jetzt auf openstreetmap.org/copyright, der Stil-Hinweis auf openstreetmap.de.
    - **Bildnachweis-Fallback**: Hero-Credit und Lightbox verlinken immer auf die Commons-Beschreibungsseite (`commonsFileUrl` aus dem Datei-Titel), auch wenn die Credit-Daten nicht geladen werden konnten — dort stehen Urheber und Lizenz.
    - **Schlacht-Detail-Button nach oben**: Der Einstieg in den Detail-Modus saß ganz unten in der Karte und ging unter. Jetzt direkt unter dem Header als gelber Primär-Button „Schlacht-Detail öffnen“ mit Hinweiszeile, was der Modus tut. Der „Zurück zur Welt-Ansicht“-Button steht an derselben Stelle.
    - **Tag 0 (21.06.1941) ohne Ostpreußen**: RUS begann als Ostfront-Land erst am 22.06., das Kaliningrader Gebiet (in NE Teil von RUS, 1941 Ostpreußen) war deshalb am Timeline-Start weder rot noch lag die Frontlinie dort. RUS-Phase startet jetzt am 21.06.
